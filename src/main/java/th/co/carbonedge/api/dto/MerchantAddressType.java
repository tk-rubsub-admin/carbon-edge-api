...
/**
 * Gets or Sets MerchantAddressType
 */
...
public enum MerchantAddressType {
  ...
  MerchantAddressType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static MerchantAddressType fromValue(String value) {
    for (MerchantAddressType b : MerchantAddressType.values()) {
