...
public class Product implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, sku, name, slug, shortDescription, description, brand, categoryId, price, currency, stockQuantity, inStock, status, isFeatured, thumbnailUrl, images, tags, createdAt, updatedAt);
  }
