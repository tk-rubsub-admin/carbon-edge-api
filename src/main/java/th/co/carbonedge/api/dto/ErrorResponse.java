...
public class ErrorResponse implements Serializable {
   ...
   */
  @NotNull 
  @Schema(name = "code", example = "PRODUCT_NOT_FOUND", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("code")
   ...
   */
  @NotNull 
  @Schema(name = "message", example = "Product not found", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull @Valid 
  @Schema(name = "timestamp", example = "2026-03-28T12:00:00Z", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(name = "details", example = "[productId 999 does not exist]", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
