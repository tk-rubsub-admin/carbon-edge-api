...
/**
 * Gets or Sets MerchantBusinessType
 */
...
public enum MerchantBusinessType {
  ...
  MerchantBusinessType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static MerchantBusinessType fromValue(String value) {
    for (MerchantBusinessType b : MerchantBusinessType.values()) {
